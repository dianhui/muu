...
public class QuickLoginAPI extends AbsOpenAPI {
     ...
     */
    public QuickLoginAPI(Context context, String appKey, Oauth2AccessToken accessToken) {
     ...
     */
    public void quickLogin(WeiboParameters params, RequestListener listener) {
        if (params != null && listener != null) {
            new AsyncWeiboRunner(mContext).request4RdirectURL(REVOKE_OAUTH_URL, params, HTTPMETHOD_POST, listener);
        } else {
